...
public class ListStatusAdapter extends ArrayAdapter<AssetDetail.Status>{
    ...
    public ListStatusAdapter(@NonNull Context context, @NonNull List<AssetDetail.Status> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        AssetDetail.Status status = getItem(position);
        ...
        viewHolder.textName.setText(status.toString());
